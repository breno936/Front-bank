      ...
      <div className="row"> 
        ...
        <div className="col-lg-9"> 
          ...
          <div className="bg-white shadow-sm rounded p-4 mb-4">
            <h3 className="text-5 fw-400 d-flex align-items-center mb-4">Informações pessoais:<a href="#edit-personal-details" data-bs-toggle="modal" className="ms-auto text-2 text-uppercase btn-link"><span className="me-1"><i className="fas fa-edit"></i></span>Editar</a></h3>
            <hr className="mx-n4 mb-4"/>
            <div className="row gx-3 align-items-center">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Nome:</p>
              <p className="col-sm-9 text-3">Smith Rhodes</p>
            </div>
            <div className="row gx-3 align-items-center">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Data de nascimento:</p>
              <p className="col-sm-9 text-3">12-09-1982</p>
            </div>
            <div className="row gx-3 align-items-baseline">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Endereço:</p>
              <p className="col-sm-9 text-3">4th Floor, Plot No.22, Above Public Park, 145 Murphy Canyon Rd,  Suite 100-18,<br/>
                San Ditego,<br/>
                California - 22434,<br/>
                United States.</p>
            </div>
                ...
                <div className="modal-body p-4">
                  <form id="personaldetails" method="post">
                    <div className="row g-3">
                      ...
                      <div className="col-12 col-sm-6">
                        <label for="lastName" className="form-label">Último nome</label>
                        <input type="text" value="Rhodes" className="form-control" data-bv-field="lastName" id="lastName" required placeholder="Last Name"/>
                      </div>
                      ...
                      <h3 className="text-5 fw-400 mt-4">Endereço</h3>
                      <hr/>
                      <div className="row g-3">
					  <div className="col-12">
                      ...
                      <div className="col-12 col-sm-6">
                          <label for="input-zone" className="form-label">Estado</label>
                          <select className="form-select" id="input-zone" name="zone_id">
					  ...
					  <div className="col-12 mt-4 d-grid"><button className="btn btn-primary" type="submit">Salvar</button></div>
                    </div>
          ...
          <div className="bg-white shadow-sm rounded p-4 mb-4">
            <h3 className="text-5 fw-400 d-flex align-items-center mb-4">Opções da conta<a href="#edit-account-settings" data-bs-toggle="modal" className="ms-auto text-2 text-uppercase btn-link"><span className="me-1"><i className="fas fa-edit"></i></span>Editar</a></h3>
            <hr className="mx-n4 mb-4"/>
            <div className="row gx-3 align-items-center">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Língua</p>
            ...
            <div className="row gx-3 align-items-center">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Status da conta:</p>
              <p className="col-sm-9 text-3"><span className="bg-success text-white rounded-pill d-inline-block px-2 mb-0"><i className="fas fa-check-circle"></i> Ativa</span></p>
            </div>
          </div>
          ...
          <div id="edit-account-settings" className="modal fade " role="dialog" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title fw-400">Opções da conta</h5>
                  <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div className="modal-body p-4">
                  <form id="accountSettings" method="post">
                    <div className="row g-3">
                      <div className="col-12">
                        <label for="language" className="form-label">Língua</label>
                        <select className="form-select" id="language" name="language_id">
                      ...
                      <div className="col-12">
                          <label for="input-timezone" className="form-label">Time Zone</label>
                          <select className="form-select" id="input-timezone" name="timezone_id">
                      ...
                      <div className="col-12">
                          <label for="accountStatus" className="form-label">Status da conta</label>
                          <select className="form-select" id="accountStatus" name="language_id">
          ...
          <div className="bg-white shadow-sm rounded p-4 mb-4">
            <h3 className="text-5 fw-400 d-flex align-items-center mb-4">Email<a href="#edit-email" data-bs-toggle="modal" className="ms-auto text-2 text-uppercase btn-link"><span className="me-1"><i className="fas fa-edit"></i></span>Editar</a></h3>
            <hr className="mx-n4 mb-4"/>
            <div className="row gx-3 align-items-center">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Email ID:</p>
              <p className="col-sm-9 text-3 d-sm-inline-flex d-md-flex align-items-center">smithrhodes1982@gmail.com<span className="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></p>
            </div>
          ...
          <div id="edit-email" className="modal fade" role="dialog" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title fw-400">Email</h5>
                  <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div className="modal-body p-4">
                  <form id="emailAddresses" method="post">
                    <div className="mb-3">
                      <label for="emailID" className="form-label d-inline-flex align-items-center">Email ID <span className="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></label>
                    ...
                    <a className="btn-link text-uppercase d-flex align-items-center text-1 float-end mb-3" href="#"><span className="text-3 me-1"><i className="fas fa-plus-circle"></i></span>Add another email</a>
                    <div className="d-grid w-100"><button className="btn btn-primary" type="submit">Salvar</button></div>
                  </form>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white shadow-sm rounded p-4 mb-4">
            <h3 className="text-5 fw-400 d-flex align-items-center mb-4">Telefone<a href="#edit-phone" data-bs-toggle="modal" className="ms-auto text-2 text-uppercase btn-link"><span className="me-1"><i className="fas fa-edit"></i></span>Editar</a></h3>
            <hr className="mx-n4 mb-4"/>
            <div className="row gx-3 align-items-center">
              <p className="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Celular:</p>
              <p className="col-sm-9 text-3 align-items-center d-sm-inline-flex d-md-flex">+1 202-555-0125<span className="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></p>
            </div>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body p-4">
                  <form id="phone" method="post">
                    <div className="mb-3">
                      <label for="mobileNumber" className="form-label d-inline-flex align-items-center">Celular <span className="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></label>
                    ...
                    <a className="btn-link text-uppercase d-flex align-items-center text-1 float-end mb-3" href="#"><span className="text-3 me-1"><i className="fas fa-plus-circle"></i></span>Add another Phone</a>
                    <div className="d-grid w-100"><button className="btn btn-primary" type="submit">Salvar</button></div>
                  </form>
                </div>
              </div>
